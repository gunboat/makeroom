...
local L = AL3:NewLocale("MakeRoom", "esES", false)
...
L["LDB_CLICK_TO_CONFIGURE"] = "Right-click|r to open the configuration menu" -- Requires localization
L["LDB_CLICK_TO_LAUNCH"] = "Click|r to find cheap items." -- Requires localization
